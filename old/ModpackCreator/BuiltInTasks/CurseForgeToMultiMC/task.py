...
class Task(ATask):
    ...
    def _run(self):
        ...
        # Always remove the options.txt file
        FilesFunctions.remove_file(mmc_minecraft_path + "/options.txt", "options.txt")
        # Always remove the config folder
        FilesFunctions.remove_dir(mmc_minecraft_path + "/config", "config")
        # Always remove the mods folder
        FilesFunctions.remove_dir(mmc_minecraft_path + "/mods", "mods")
        # Always remove the resourcepacks folder
        FilesFunctions.remove_dir(mmc_minecraft_path + "/resourcepacks", "resourcepacks")
        # Always remove the shaderpacks folder
        FilesFunctions.remove_dir(mmc_minecraft_path + "/shaderpacks", "shaderpacks")
